...
const alertsData = [
  ...
  },
  {
    ...
    description: 'Power draw of 2.4kW detected at 11:30 PM (Expected: < 0.5kW).',
    suggestedAction: 'Verify authorized access or check for equipment left running.',
    time: '14 hrs ago',
  ...
  },
  {
    ...
    suggestedAction: 'Prepare for brief power interruption during switchover test.',
    time: '1 day ago',
    ...
    >
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-2">
        <div>
          ...
          <p className="text-slate-400 mt-1">Monitor system anomalies and required actions.</p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        {filteredAlerts.map(alert => {
          ...
          const glowColor =
            alert.type === 'critical' ? 'red' : alert.type === 'warning' ? 'amber' : 'none';
          const iconBg =
            alert.type === 'critical'
                ...
                <div className="flex-1">
                  ...
                  <div className="bg-white/[0.03] border border-white/[0.05] rounded-lg p-3 flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <span className="text-sm text-slate-300">{alert.suggestedAction}</span>
                    </div>
                  </div>
                </div>
