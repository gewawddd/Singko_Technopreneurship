      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-2">
        <div>
          ...
          <p className="text-slate-400 mt-1">
            Historical trends and cost analysis.
          </p>
        </div>
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex space-x-1 bg-white/[0.05] p-1 rounded-lg border border-white/[0.05]">
              ...
              <button
                key={t}
                onClick={() => setView(t)}
                className={`px-3 py-1 rounded-md text-xs font-medium capitalize transition-colors ${view === t ? 'bg-white/[0.1] text-white' : 'text-slate-400 hover:text-white'}`}>
