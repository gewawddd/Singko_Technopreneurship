    ...
    >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        ...
        <GlassCard className="!p-5 border-emerald-500/20">
          ...
          <p className="text-lg font-bold text-white truncate">Branch 3 - Davao</p>
        </GlassCard>
      </div>
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            ...
            <p className="text-slate-300 text-sm leading-relaxed">
              <span className="text-amber-400 font-medium">Warehouse Hub — Quezon City</span> is
              consuming 8.4% more energy than last week and has the highest cost-per-device ratio
              across all branches. Consider scheduling an energy audit.
            </p>
          </div>
        </div>
      </GlassCard>
        ...
        {branches.map(branch => {
          ...
          return (
            <motion.div key={branch.id} variants={itemVariants}>
              <GlassCard hover glowColor={glowColor} className="relative overflow-hidden">
                ...
                <div className="flex justify-between items-start mb-6 relative z-10">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-slate-400 text-sm">{branch.devices} monitored devices</p>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-4 relative z-10">
                  <div className="bg-white/[0.02] p-4 rounded-xl border border-white/[0.05]">
                    ...
                    <div className="flex items-baseline space-x-2">
                      <span className="text-2xl font-bold text-white">{branch.usage}</span>
                  ...
                  <div className="bg-white/[0.02] p-4 rounded-xl border border-white/[0.05]">
                    <p className="text-xs text-slate-500 mb-1">Est. Monthly Cost</p>
                    <div className="flex items-baseline space-x-2">
                      <span className="text-2xl font-bold text-white">{branch.cost}</span>
                    </div>
