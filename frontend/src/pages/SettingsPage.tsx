...
import { UserIcon, BellIcon, SlidersIcon, SaveIcon } from 'lucide-react';
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input type="number" defaultValue={210} className="glass-input w-full" />
              </div>
              <div>
                <label className="block text-sm font-medium text-slate-300 mb-2">
                  Voltage Maximum (V)
                </label>
                <input type="number" defaultValue={240} className="glass-input w-full" />
              </div>
            </div>
            <div>
              <label className="block text-sm font-medium text-slate-300 mb-2">
              ...
              <input type="number" defaultValue={40} className="glass-input w-full" />
        ...
        <GlassCard>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input type="text" defaultValue="Hardware Pro Inc." className="glass-input w-full" />
            </div>
          </div>
        </GlassCard>
      </motion.div>
